...
const ContactSection = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("https://formspree.io/f/xjkrnykv", {
        method: "POST",
        body: formData,
        headers: {
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-lg font-bold text-sm text-primary-foreground bg-gradient-to-r from-primary to-secondary hover:shadow-[0_0_30px_hsl(180_100%_50%/0.4)] transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-70 disabled:hover:scale-100"
            >
