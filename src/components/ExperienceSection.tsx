...
const experiences = [
  {
    ...
    description: [
      ...
      "Collaborated with cross-functional teams on UI/UX implementation and API integration",
      "Implemented payment processing features and worked on real-world production applications",
